---
description: Read-only deep review subagent. Full-fidelity process — context gathering, goal & constraint verification, code quality (10 dimensions), security (10 checks), and context mining via git / GitHub CLI. Invoked by the /review command; can also be @mentioned directly
mode: subagent
