-- ============================================================================
--  Keybindings  (from modules/binds.conf)
--  Wiki: https://wiki.hypr.land/Configuring/Basics/Binds/
--        https://wiki.hypr.land/Configuring/Basics/Dispatchers/  (hl.dsp.* surface)
--  Per-host: screenshot key + machine-specific exec binds — see
--  modules/machine.lua (M.screenshot_key, M.extra_binds).
-- ============================================================================
...
-- ---- machine-specific exec binds (e.g. laptop: hyprlock + keyboard backlight) ----
for _, b in ipairs(M.extra_binds) do
    hl.bind(b.mod .. " + " .. b.key, hl.dsp.exec_cmd(b.cmd))
end
...
-- `bindel` flag `e` = repeat; holding the key ramps volume/brightness continuously.
...
-- ---- screenshots (hyprshot): key is per-host (PRINT / F11 / ...) ----
local screenshot_key = M.screenshot_key
hl.bind(mainMod .. " + " .. screenshot_key,         hl.dsp.exec_cmd("hyprshot -m window"))
hl.bind(screenshot_key,                             hl.dsp.exec_cmd("hyprshot -m output"))
hl.bind(mainMod .. " + SHIFT + " .. screenshot_key, hl.dsp.exec_cmd("hyprshot -m region"))
